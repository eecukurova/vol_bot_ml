# ✅ ETH Projesi - Tamamlanan Özellikler
...
- `ETH/src/regime.py` - Regime detection
- `ETH/src/slippage.py` - Dynamic slippage
- `ETH/src/latency.py` - Latency tracking
- `ETH/src/position_management.py` - Break-even, trailing, trade blocker
- `ETH/src/shadow_mode.py` - Shadow mode tracking
- `ETH/src/perp_features.py` - Perp-specific features
- `ETH/src/calibration.py` - Probability calibration
- `ETH/src/leverage.py` - Dynamic leverage management

## 🔄 Güncellenen Dosyalar

- `ETH/src/features.py` - Data leakage prevention
- `ETH/src/live_loop.py` - Tüm özellikler entegre edildi
- `ETH/src/infer.py` - Calibration entegrasyonu
- `ETH/src/backtest_core.py` - Funding costs eklendi
