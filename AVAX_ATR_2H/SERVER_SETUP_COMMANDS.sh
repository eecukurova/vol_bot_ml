#!/bin/bash
# AVAX ATR 2H Projesi - Sunucu Kurulum Scripti
# Bu script sunucuda çalıştırılmalı

set -e

echo "🚀 AVAX ATR 2H Projesi - Sunucu Kurulumu"
echo ""

PROJECT_DIR="/opt/avax_atr_2h"
cd "$PROJECT_DIR"
...
echo "   tail -f $PROJECT_DIR/runs/avax_atr_live.log"
echo ""
echo "📋 Service durumu:"
echo "   systemctl status avax_atr_live.service"
echo ""
echo "🔄 Service yönetimi:"
echo "   systemctl restart avax_atr_live.service  # Yeniden başlat"
echo "   systemctl stop avax_atr_live.service      # Durdur"
echo "   systemctl start avax_atr_live.service     # Başlat"
