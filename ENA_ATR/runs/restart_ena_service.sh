...
# ENA ATR Live Service Restart Script
# Bu script ENA ATR servisini restart eder ve durumunu kontrol eder

set -e

SERVICE_NAME="ena_atr_live"
PROJECT_DIR="/root/volensy_quik_gain/ENA_ATR"
LOG_FILE="$PROJECT_DIR/runs/ena_live.log"
CONFIG_FILE="$PROJECT_DIR/configs/llm_config.json"

echo "🔄 ENA ATR Live Service Restart Script"
echo "========================================"
echo ""
...
[Unit]
Description=ENA ATR Live Trading Service
