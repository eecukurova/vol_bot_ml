#!/bin/bash
# PIPPIN ATR 2H Projesi - Sunucu Kurulum Scripti
# Bu script sunucuda çalıştırılmalı

set -e

echo "🚀 PIPPIN ATR 2H Projesi - Sunucu Kurulumu"
echo ""

PROJECT_DIR="/root/volensy_quik_gain/PIPPIN_ATR_2H"
cd "$PROJECT_DIR"
...
echo "   tail -f $PROJECT_DIR/runs/pippin_atr_live.log"
echo ""
echo "📋 Service durumu:"
echo "   systemctl status pippin_atr_live.service"
echo ""
echo "🔄 Service yönetimi:"
echo "   systemctl restart pippin_atr_live.service  # Yeniden başlat"
echo "   systemctl stop pippin_atr_live.service      # Durdur"
echo "   systemctl start pippin_atr_live.service     # Başlat"
