...
A Transformer-based sequence classifier for SOLUSDT futures scalping with 0.5% take-profit targets and adaptive stop-loss via grid search.

## 🎯 Approach

- **Target**: 0.5% TP scalping on SOLUSDT
...
Data saved to `data/SOLUSDT_3m.csv` with columns: `time,open,high,low,close,volume`.
...
make live
# or
python scripts/live_demo_runner.py --symbol SOLUSDT --timeframe 3m \
...
- Working directory: `/root/ATR/SOL`
