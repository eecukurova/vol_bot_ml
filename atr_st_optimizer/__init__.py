"""
ATR + SuperTrend Strategy Optimizer

A comprehensive Python package for optimizing ATR + SuperTrend trading strategies
with ccxt data integration, grid search optimization, and walk-forward analysis.
"""
