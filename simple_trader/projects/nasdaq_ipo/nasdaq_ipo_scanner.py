#!/usr/bin/env python3
"""
NASDAQ IPO Scanner - $5 altındaki tüm teknoloji firmalarını tarar
"""
...
class NASDAQDynamicScanner:
    def __init__(self, config_file='nasdaq_ipo_config.json'):
        # Logging setup
        logging.basicConfig(
            level=logging.INFO,
...
"""
    ...
    def run(self):
        """Ana döngü"""
        self.log.info("🚀 NASDAQ IPO Scanner başlatıldı")
        ...
        while True:
            try:
                ...
                self.log.info("🛑 NASDAQ IPO Scanner durduruluyor...")
                break
            except Exception as e:
