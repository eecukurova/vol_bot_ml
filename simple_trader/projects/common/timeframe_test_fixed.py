#!/usr/bin/env python3
"""
Timeframe Karşılaştırma Test Script - Düzeltilmiş
SOL/USDT için desteklenen timeframe'leri test et
"""
...
def test_timeframe(symbol, timeframe, days=30):
    ...
    try:
        ...
        print(f"❌ {timeframe} timeframe hatası: {e}")
        return {
            'total_trades': 0,
            'win_rate': 0,
            'total_return': 0,
...
def main():
    ...
    if valid_results:
        ...
        best_dd = min(valid_results.items(), key=lambda x: x[1]['max_drawdown'])
