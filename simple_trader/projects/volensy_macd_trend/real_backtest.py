#!/usr/bin/env python3
"""
Volensy MACD Gerçek Backtest - Trading Mantığı ile
...
class VolensyMacdRealBacktest:
    ...
    def generate_signal(self, df, current_time):
        ...
        try:
            ...
            if self.last_signal_time:
                ...
                if hours_since_last < self.signal_cooldown_hours:
                    return None
    ...
    def open_position(self, signal_data, current_time):
        ...
        try:
            ...
            print(f"🚀 {signal} Pozisyon Açıldı @ ${price:.4f}")
    ...
    def run_backtest(self, days=30):
        """Backtest çalıştır"""
        try:
            print(f"🚀 Volensy MACD Gerçek Backtest - {self.symbol}")
            ...
            print(f"⏰ Sinyal Cooldown: {self.signal_cooldown_hours} saat")
            print("="*80)
...
if __name__ == "__main__":
    backtest = VolensyMacdRealBacktest("SUI/USDT", initial_balance=1000)
