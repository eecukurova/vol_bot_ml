#!/usr/bin/env python3
"""
Volensy MACD Gerçek Backtest - Düzeltilmiş
- Veri yetersizliği sorunu çözüldü
...
class VolensyMacdRealBacktestFixed:
    ...
    def run_backtest(self, days=30):
        """Backtest çalıştır"""
        try:
            print(f"🚀 Volensy MACD Gerçek Backtest (Düzeltilmiş) - {self.symbol}")
            ...
            print(f"📊 Minimum Bar Gereksinimi: {self.min_bars}")
            print("="*80)
...
if __name__ == "__main__":
    backtest = VolensyMacdRealBacktestFixed("SUI/USDT", initial_balance=1000)
